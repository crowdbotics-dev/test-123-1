"""
Django settings for test_123_1 project.
...
WSGI_APPLICATION = 'test_123_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_123_1 API",
    "DESCRIPTION": "API documentation for test_123_1 App",
    "VERSION": "v1",
}
